...
from settings import DEVICE, EPOCHS, STYLE_PATH, CONTENT_PATH, BLANK_PATH, OUTPUT_PATH, STYLE_WEIGHT, CONTENT_WEIGHT

style_image = utils.load_image(STYLE_PATH)
content_image = utils.load_image(CONTENT_PATH)
# blank_image = utils.load_image(BLANK_PATH)
...
# target_image = blank_image.clone()
